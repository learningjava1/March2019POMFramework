...
public class ContactsPage extends BasePage{
	...
	//Here we identify the WebElements 
	...
	//Now we need to create a Constructor of the page class, 
	//and pass the 'WebDriver driver' instance inside the Constructor class:
	...
	//Now we'll create Actions/Methods:
