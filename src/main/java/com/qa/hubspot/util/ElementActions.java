...
public class ElementActions extends BasePage{
	...
	//Now we'll start creating our generic utilities or Wrappers
	//Wrappers mean, you're creating one more layer in top of Selenium Methods
	...
	//This will be void in nature, because I don't want to return anything for SendKeys
